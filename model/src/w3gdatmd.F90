...
9003 FORMAT (' TEST W3DIMS : DIMENSIONS STORED')
  ...
  SUBROUTINE W3SETG ( IMOD, NDSE, NDST )
    ...
    GQMDIAFIN => MPARS(IMOD)%SNLPS%GQMDIAFIN
    GQMDIAFDS => MPARS(IMOD)%SNLPS%GQMDIAFDS
    GQMDIA_WND_THR=> MPARS(IMOD)%SNLPS%GQMDIA_WND_THR
    GQMDIA_HS_THR=> MPARS(IMOD)%SNLPS%GQMDIA_HS_THR
#endif
#ifdef W3_NL2
    IQTPE  => MPARS(IMOD)%SNLPS%IQTPE

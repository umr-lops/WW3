  ...
  SUBROUTINE W3IOGR ( INXOUT, NDSM, IMOD, FEXT &
    ...
    IF ( WRITE ) THEN
      WRITE (NDSM)                                         &
           ...
           GQTHRSAT, GQFRESAT, GQTHRCOU, GQAMP, GQMDIA, GQMDIA_HS_THR, GQMDIA_WND_THR, GQMDIAFIN, GQMDIAFDS
#ifdef W3_ASCII
      WRITE (NDSA,*)                                       &
           'SNLC1, LAM, KDCON, KDMN, SNLS1, SNLS2, SNLS3,  &
           IQTPE, NLTAIL, GQNF1, GQNT1,                    &
           GQNQ_OM2, GQTHRSAT,  GQFRESAT, GQTHRCOU, GQAMP:',          &
           SNLC1, LAM, KDCON, KDMN, SNLS1, SNLS2, SNLS3,   &
           IQTPE, NLTAIL, GQNF1, GQNT1, GQNQ_OM2,          &
           GQTHRSAT, GQFRESAT, GQTHRCOU, GQAMP, GQMDIA, GQMDIA_HS_THR, GQMDIA_WND_THR, GQMDIAFIN, GQMDIAFDS
#endif
    ELSE
      READ (NDSM,IOSTAT=IERR)                              &
           SNLC1, LAM, KDCON, KDMN, SNLS1, SNLS2, SNLS3,   &
           IQTPE, NLTAIL, GQNF1, GQNT1,                    &
           GQNQ_OM2, GQTHRSAT, GQFRESAT, GQTHRCOU, GQAMP, GQMDIA, GQMDIA_HS_THR, GQMDIA_WND_THR, GQMDIAFIN, GQMDIAFDS
    END IF
